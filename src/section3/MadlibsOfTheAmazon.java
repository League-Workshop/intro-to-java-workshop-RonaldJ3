...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "if you find yourself haviing to cross a piranha-infested river, here's how to do it");
		...
		String partString  = JOptionPane.showInputDialog("body part");
